...
app.get('/api/weather', async (req, res) => {
  try {
    ...
    const DEVICE_URLS = {
      'c055eef5-b6dc-406e-ad5a-65dec60db90e': 'https://iot.skd-ka.de/api/v1/devices/c055eef5-b6dc-406e-ad5a-65dec60db90e/readings?limit=100&sort=measured_at&sort_direction=desc&auth=F20B6E04DCB4C114543B9E1BBACE3C26', // Kaiserplatz
      '7ceb0590-e2f0-4f9e-a3dc-5257a4729f57': 'https://iot.skd-ka.de/api/v1/devices/7ceb0590-e2f0-4f9e-a3dc-5257a4729f57/readings?limit=100&sort=measured_at&sort_direction=desc&auth=F20B6E04DCB4C114543B9E1BBACE3C26' // Albtahl
    };
